...
inputFastqGzReadR1 = "/project/arjunrajlab/mapseq/repo/VitoData/Analysis/stepZero/R1Subset2.fastq.gz"
inputFastqGzReadR2 = "/project/arjunrajlab/mapseq/repo/VitoData/Analysis/stepZero/R2Subset2.fastq.gz"
staggerLength = 4 #length of the stagger (e.g. For i7.3.1 corresponding to sample 1, it is 1)
outputDirectory = "/project/arjunrajlab/mapseq/repo/VitoData/Analysis/stepOne/subset2/"
...
for read, Qscore in zip(joinedRead1Read2, read2QscoreInt):
	...
	cellID = read[0][0:16]
	UMI = read[0][17:26]
	barcode = read[1][sumGfpPrimerStaggrer:(sumGfpPrimerStaggrer + 48)]  #needs to change depending on the sample
