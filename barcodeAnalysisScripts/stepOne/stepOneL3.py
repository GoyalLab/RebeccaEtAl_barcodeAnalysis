...
inputFastqGzReadR1 = "/project/arjunrajlab/mapseq/repo/VitoData/Analysis/stepZero/segmentacR1.fastq.gz"
inputFastqGzReadR2 = "/project/arjunrajlab/mapseq/repo/VitoData/Analysis/stepZero/segmentacR2.fastq.gz"
staggerLength = 4 #length of the stagger (e.g. For i7.3.1 corresponding to sample 1, it is 1)
outputDirectory = "/project/arjunrajlab/mapseq/repo/VitoData/Analysis/stepOne/L3/"
